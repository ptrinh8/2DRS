...
public class FMODEventEmitterInspector : Editor
{
	...
	{	
		...
		{
			emitter.path = emitter.asset.guid; // Note: set path to guid just in case the asset gets deleted
			...
			GUILayout.BeginHorizontal();	
			{
				...
				EditorGUILayout.SelectableLabel(emitter.asset.guid, GUILayout.Height(14));
			}
			GUILayout.EndHorizontal();
