...
{		
	...
	public class Factory
    {
        public static RESULT System_Create(out System studiosystem)
        {
            ...
            result = FMOD_Studio_System_Create(out systemraw);
            if (result != RESULT.OK)
            {
                return result;
            }
        ...
        private static extern RESULT FMOD_Studio_System_Create                      (out IntPtr studiosystem);
	...
	public class Util
	{
		...
		{
			return FMOD_Studio_ParseID(idString, out id);
		}

        #region importfunctions

        [DllImport (STUDIO_VERSION.dll)]
        private static extern RESULT FMOD_Studio_ParseID                      (string idString, out GUID id);
    ...
    public class System : HandleBase
    {
        ...
        {
            return FMOD_Studio_System_LookupEventID(rawPtr, path, out guid);
        }
        public RESULT lookupBusID(string path, out GUID guid)
        {
            return FMOD_Studio_System_LookupBusID(rawPtr, path, out guid);
        }
        ...
        public RESULT load(string name_or_data, out Bank bank )
        {
            RESULT result = RESULT.OK;
            ...
            try
            {
                result = FMOD_Studio_System_LoadBankFile(rawPtr, name_or_data, out bankraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        [DllImport (STUDIO_VERSION.dll)]
        private static extern RESULT FMOD_Studio_System_LookupEventID           (IntPtr studiosystem, string path, out GUID guid);
        [DllImport (STUDIO_VERSION.dll)]
		private static extern RESULT FMOD_Studio_System_LookupBusID				(IntPtr studiosystem, string path, out GUID guid);
		[DllImport (STUDIO_VERSION.dll)]
        private static extern RESULT FMOD_Studio_System_SetListenerAttributes   (IntPtr studiosystem, ref _3D_ATTRIBUTES attributes);
        [DllImport (STUDIO_VERSION.dll)]
        private static extern RESULT FMOD_Studio_System_LoadBankFile            (IntPtr studiosystem, string filename, out IntPtr bank);
        [DllImport (STUDIO_VERSION.dll)]
    ...
    public class EventInstance : HandleBase
    {
        ...
        public RESULT getParameter(string name, out ParameterInstance instance)
        {
            ...
            try
            {
                result = FMOD_Studio_EventInstance_GetParameter(rawPtr, name, out parameterinstanceraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT getCue(string name, out CueInstance instance)
        {
            ...
            try
            {
                result = FMOD_Studio_EventInstance_GetCue(rawPtr, name, out cueinstanceraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT createSubEvent(string name, out EventInstance instance)
        {
            ...
            try
            {
                result = FMOD_Studio_EventInstance_CreateSubEvent(rawPtr, name, out subeventraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        [DllImport(STUDIO_VERSION.dll)]
        private static extern RESULT FMOD_Studio_EventInstance_GetParameter         (IntPtr _event, string name, out IntPtr parameter);
        [DllImport(STUDIO_VERSION.dll)]
        private static extern RESULT FMOD_Studio_EventInstance_GetParameterByIndex  (IntPtr _event, int index, out IntPtr parameter);
        [DllImport(STUDIO_VERSION.dll)]
        private static extern RESULT FMOD_Studio_EventInstance_GetCue               (IntPtr _event, string name, out IntPtr cue);
        [DllImport(STUDIO_VERSION.dll)]
        private static extern RESULT FMOD_Studio_EventInstance_CreateSubEvent       (IntPtr _event, string name, out IntPtr _instance);
        [DllImport(STUDIO_VERSION.dll)]
